...
import com.example.android.navigation.databinding.FragmentGameNotWonBinding
import timber.log.Timber


class GameNotWonFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding: FragmentGameNotWonBinding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_game_not_won, container, false)
        binding.nextMatchButton.setOnClickListener { view: View ->
            view.findNavController().navigate(R.id.action_GameNotWonFragment_to_gameFragment)
        }
